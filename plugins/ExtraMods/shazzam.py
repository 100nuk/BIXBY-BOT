...
import asyncio, time, os, datetime, requests, yt_dlp
...
from plugins.helper.shazzam import humanbytes, edit_or_reply, fetch_audio, runcmd
NOT_SUPPORT = [ ]
...
async def shazam_(client, message):
    ...
    caption = f"""<b><u>𝙶𝚎𝚗𝚎𝚛𝚊𝚝𝚎𝚍 𝙱𝚢 @Movie_search_V4_bot</b></u>
